    ...
    <>
      <div className="flex gap-4">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 text-white bg-[#1877F2] hover:bg-[#1877F2]/90" // Use Facebook blue color
        >
          Sign In with Facebook {/* Update text */}
          {/* Removed GitHub SVG */}
          {/* Placeholder for Facebook Icon if needed later */}
